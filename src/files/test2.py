    ...
    while True:
        ...
        if __isRunning:
            ...
            if tag_id is not None:
                ...
                while object_x is not None and tag_id is not None:
                    if object_x - center_x >50:
                        AGC.runActionGroup('right_move_30')#扭腰
                        time.sleep(0.5)
                    elif object_x - center_x < -50:
                        AGC.runActionGroup('left_move_30')#右转
                        time.sleep(0.5)
                    else:
                        break
                
                while angle is not None and tag_id is not None:
                    print(angle)
                    if angle > 0 and angle < 175:
                        AGC.runActionGroup('turn_left_fast')#右转
                        time.sleep(0.1)
                    elif angle > -175 and angle < 0:
                        AGC.runActionGroup('turn_right_fast')#扭腰
                        time.sleep(0.1)
                    else:
                        break
